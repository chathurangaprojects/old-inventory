        ...
        <script type="text/javascript">
            $(function(){
                    ...
                    new AjaxUpload(btnUpload, {
                            action: '<?php echo base_url(); ?>index.php/item_master/upload_master_item',
                            name: 'uploadfile',
                        ...
                        // extension is not allowed 
                                    ...
                                    $("#sta").html("<img src='<?php echo base_url(); ?>resources/scripts/js/loader.gif' alt='Loading' />");
                            ...
                            onComplete: function(file, response){
                                    ...
                                    if(response!="error"){
                            $('#files').html('<img src="<?php echo base_url(); ?>uploads/'+response+'" alt="" width="150" /><br />'+file).addClass('success');
                                             picFileName = response;
                                             document.getElementById("picture").value = picFileName;
                                    } else{
