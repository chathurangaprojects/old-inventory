<div class="inner-page-title">
    <h2>Edit Master Items</h2>
    <span>You can edit existing master items.</span>
</div>
...
<div class="content-box content-box-header">
    <div class="content-box-wrapper">
            ...
            <?php echo form_open_multipart(base_url() . 'index.php/item_master/edit_items'); ?>
                ...
                <fieldset>
                        <ul>
                            ...
                            <li>
                                ...
                                <div><b>Search: </b><input type="text" id="item_name_edit" class="field text medium" name="txt_item_name" onkeypress="get_item_type(this.value);" onchange="get_item_type(this.value);" onblur="get_item_type(this.value);"/>
                                    <!-- <input type="button" value="Search" onclick="get_item_type(document.getElementById('item_name_edit').value);" /> -->
                                </div>
                                <script type="text/javascript">
                                    var item_name_edit = new LiveValidation('item_name_edit', {onlyOnSubmit: true });
                                    item_name_edit.add( Validate.Presence, {failureMessage: "Please Enter Existing Item Name"} );
                                </script>
                            </li>
                            ...
                            <li>
                                ...
                                <div><input type="text" id="new_item_name_edit" class="field text full" name="txt_new_item_name" /></div>
                                <script type="text/javascript">
                                    var new_item_name_edit = new LiveValidation('new_item_name_edit', {onlyOnSubmit: true });
                                    new_item_name_edit.add( Validate.Presence, {failureMessage: "Please Enter New Item Name"} );
                                </script>
                            </li>
                            ...
                            <li>
                                ...
                                <div>
                                    <!-- <input id="item_type" class="field text full" name="txt_item_type" onkeyup="showProperties3(this.value)" onchange="showProperties3(this.value)" onblur="showProperties3(this.value)" /> -->
                                    <input id="item_type" class="field text full" name="txt_item_type" />
                                </div>
                                <script type="text/javascript">
                            ...
                            <li>
                                    ...
                                    <div>
                                        ...
                                        <input type="hidden" id="picture" name="txt_picture" />
                            ...
                            <li>
                                ...
                                <div>
                                    <button class="ui-state-default ui-corner-all float-left ui-button" type="submit">Edit Item</button>
                                </div>
                            </li>
                        </ul>
                </fieldset>
